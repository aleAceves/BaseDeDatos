...
public class Xml2Html {
	...
	public static void main(String[] args) {
		simpleTransform("./xmls/Output-Surgeon.xml", "./xmls/surgeonStyle.xslt", "./xmls/Surgeon.html");
		simpleTransform("./xmls/Output-Nurse.xml", "./xmls/nurseStyle.xslt", "./xmls/Nurse.html");
		simpleTransform("./xmls/Output-Patient.xml", "./xmls/patientStyle.xslt", "./xmls/Patient.html");
		simpleTransform("./xmls/Output-Operation.xml", "./xmls/AOperationStyle.xslt", "./xmls/Operation.html");
